...
MIO.PersonalAllowance = function(){
    this.income = 0;
...
MIO.PersonalAllowance.prototype = {
    ...
    setValuesFromTaxCode : function(taxCode){
        var taxCodeCalculator = new TCC.TaxCodeCalculator(taxCode);
...
MIO.PersonalAllowanceFactory = function(persona, taxYear){
    var pa = new MIO.PersonalAllowance();
